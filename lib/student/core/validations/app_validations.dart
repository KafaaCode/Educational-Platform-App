...
class AppValidators {
  ...
  static String? validateFirstName(String? value) {
    ...
    if (!AppRegExp.stringRegExp.hasMatch(value)) {
      return 'pleaseEnterOnlyAlphabeticalCharacters'; //PleaseEnterOnlyAlphabeticalCharacters
    }
    return null;
  }
  ...
  static String? validateCardHolderName(String? value) {
    ...
    if (!AppRegExp.stringRegExp.hasMatch(value)) {
      return 'pleaseEnterValidCardholderName'; //PleaseEnterValidCardholderName
    }
    return null;
  }
  ...
  static String? validateCardNumber(String? value) {
    ...
    if (!AppRegExp.cardNumberRegExp.hasMatch(value)) {
      return 'pleaseEnterValid16digitCreditCardNumber'; //PleaseEnterValid16digitCreditCardNumber
    }
  ...
  static String? validateCardSecurityCode(String? value) {
    ...
    if (!AppRegExp.securityCodeRegex.hasMatch(value)) {
      return 'securityCodeShouldContainOnlyDigits'; //SecurityCodeShouldContainOnlyDigits
    }
    return null;
  }
}
