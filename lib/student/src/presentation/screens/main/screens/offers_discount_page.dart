...
class OffersDiscountPage extends StatefulWidget {
  const OffersDiscountPage({super.key});

  @override
  _TeacherPage createState() => _TeacherPage();
}

class _TeacherPage extends State<OffersDiscountPage> {
  @override
  void dispose() {
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
          ...
          child: BlocProvider(
            create: (context) => OffersDiscountBloc(sl())
